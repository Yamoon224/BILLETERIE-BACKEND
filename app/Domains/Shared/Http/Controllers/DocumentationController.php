 ...
 * promis aux consommateurs — notamment a l'equipe qui construira l'application
 * agent Android — sans encombrer les controleurs de dizaines de lignes
 * d'annotations.
 *
 * Sa coherence avec les routes reellement enregistrees est verifiee par un
 * test automatise (`OpenApiSpecificationTest`), ce qui empeche la
 * documentation de deriver silencieusement du code.
 */
