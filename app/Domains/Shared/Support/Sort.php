 ...
 * publique** (`departure`, `amount`…) que chaque depot traduit lui-meme, via
 * une allowlist, en colonne ou en expression SQL. C'est la seule facon de
 * proposer un tri par en-tete sans ouvrir une injection SQL, et cela permet en
 * prime de trier sur une donnee qui n'est pas une colonne — le nom d'une
 * compagnie, le taux de remplissage d'un depart — sans que le frontend ait a
 * le savoir.
 */
final class Sort
{
    ...
    /**
     * Le parametre est generique sur le modele : sans cela, un Builder de Trip
     * ne serait pas accepte la ou un Builder de Model est attendu — le
     * parametre de type d'Eloquent n'est pas covariant.
     *
